...
export async function buildIdentity(root){
 ...
 const hashes={};for(const path of paths.sort())hashes[path]=hash(await readFile(join(root,path)));
 ...
 const core={schemaVersion:1,packageVersion:JSON.parse(await readFile(join(root,'package.json'),'utf8')).version,
